...
TEXTS = {
    "zh": {
        "title": "🌐 智能量化金融终端 (V9.1 硬核旗舰版)",
        "subtitle": "完美融合 线性衰减DCF、热力图、动态NWC与折旧瀑布流、LBO模型 与双视角AI",
        "quick_tag": "🔥 热门快捷测评：",
    ...
    "en": {
        "title": "🌐 Universal Quant Terminal (Ultimate Hardcore V9.1)",
        "subtitle": "Integrating Fading Growth DCF, Capex Waterfall, Dynamic NWC & LBO Cash Sweep",
...
# ==============================================================================
# 3. 核心硬核量化引擎 (集成 NWC、折旧瀑布流与全动态 FCF)
# ==============================================================================
...
def main():
    ...
    if ticker_input:
        with st.spinner("Compiling Hardcore Institutional Engine..."):
            ...
            # ==========================================
            # TAB 1: 完整的原版 V8.9 Plus (全量且排版完整的保留)
            # ==========================================
            with tab1:
                with st.container(border=True):
